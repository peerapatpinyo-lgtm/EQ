...
with tab2:
    ...
    with st.expander("🔍 ดูวิธีพิจารณาประเภทการออกแบบของอาคารนี้ (คลิกเพื่อขยาย)", expanded=True):
        ...
        # --- ตารางอ้างอิง Ie ---
        st.markdown("**(ตารางอ้างอิง) ประเภทความสำคัญของอาคารและค่า $I_e$ ตามมาตรฐาน มยผ.**")
        ie_data = {
            "ระดับความสำคัญ": ["อาคารทั่วไป", "อาคารความสำคัญสูง", "อาคารความสำคัญสูงมาก"],
            "ค่า Ie": ["1.00", "1.25", "1.50"],
            "ลักษณะอาคาร (ตัวอย่าง)": [
                "ที่พักอาศัย, อาคารพาณิชย์, สำนักงานทั่วไป (ความเสี่ยงปกติต่อชีวิต)",
                "โรงเรียน, สถานที่ชุมนุมคนจำนวนมาก, อาคารสาธารณะขนาดใหญ่",
                "โรงพยาบาล, สถานีดับเพลิง, ศูนย์สื่อสาร, อาคารจำเป็นหลังภัยพิบัติ"
            ]
        }
