...
with tab5:
    ...
    st.markdown("""
    ส่วนสรุปภาพรวมพารามิเตอร์ภัยแผ่นดินไหว ระบบโครงสร้าง และเสถียรภาพอาคารในรูปแบบแผนภูมิกระบวนการที่เชื่อมโยงข้อมูลแบบพลวัต (Dynamic Flowchart) ออกแบบมาเพื่อเป็น **Executive Summary** ประจำโครงการ ช่วยลดระยะเวลาในการอ่านรายการคำนวณและเพิ่มความสะดวกในการตรวจสอบสอบทานแบบ (Design Review) จัดวางหน้ากระดาษพร้อมสำหรับสั่งพิมพ์เพื่อแนบร่วมกับเอกสารขออนุญาตก่อสร้าง
    """)
